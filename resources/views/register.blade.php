...
<body>
    ...
    <div class="authentication-wrapper authentication-cover">
        <!-- Logo -->
        <a href="{{ url('/register') }}" class="auth-cover-brand d-flex align-items-center gap-2">
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-flex col-12 col-lg-5 col-xl-4 align-items-center authentication-bg position-relative py-sm-12 px-12 py-6">
                <div class="w-px-410 mx-auto pt-5 pt-lg-0">
                    <h4 class="mb-1">Welcome to Register Page!👋</h4>
                    <form id="registerForm" method="post" class="mb-5" action="{{ url('registration') }}">
                        @csrf
